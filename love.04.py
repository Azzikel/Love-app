...
function generateLetter(type = "love") {
    const openings = ["My love,","To the most amazing person in my life,","My dearest,","Every day I think about you,","To the one who owns my heart,"];
    const feelings = ["you make ordinary moments feel magical.","your smile brightens every part of my day.","being with you feels like home.","you make me feel lucky every single day.","your love gives me strength."];
    const memories = ["I still smile whenever I remember our sweetest moments together.","Every memory we create becomes one of my favorites.","The little things we share mean everything to me.","Even simple conversations with you become unforgettable.","You make every chapter of my life beautiful."];
    const promises = ["I promise to keep choosing you every day.","I will always stand beside you.","I will love you through every season of life.","I will never stop appreciating you.","I will always protect our love."];
    const endings = ["Forever yours.","With all my love.","Always and forever.","Your biggest fan and lover.","My heart belongs to you."];
    return `${randomItem(openings)}\n\n${randomItem(feelings)}\n\n${randomItem(memories)}\n\n${randomItem(promises)}\n\n${randomItem(endings)}`;
}

function generatePoem() {
    const line1 = ["The stars glow softly tonight,","Moonlight dances across the sky,","The evening breeze whispers gently,","A thousand dreams surround us,"];
    const line2 = ["just like your beautiful smile.","reminding me of your eyes.","carrying thoughts of you.","bringing warmth to my heart."];
    const line3 = ["Every heartbeat speaks your name,","My soul reaches only for yours,","Love grows stronger every day,","You are my sweetest melody,"];
    const line4 = ["and forever I will cherish you.","for you are my greatest treasure.","and my heart belongs to you.","until the end of time."];
    return `${randomItem(line1)}\n${randomItem(line2)}\n${randomItem(line3)}\n${randomItem(line4)}`;
}

function generateCompliment() {
    const starters = ["You have","I admire","Everyone notices","One thing I love is","I appreciate"];
    const traits = ["your kindness","your beautiful smile","your intelligence","your caring heart","your confidence","your warmth","your patience","your positivity"];
    const endings = ["because it makes the world brighter.","and it inspires everyone around you.","which is one of your most special qualities.","and that's what makes you unforgettable.","and it makes me love you even more."];
    return `${randomItem(starters)} ${randomItem(traits)} ${randomItem(endings)}`;
}
...
function getRandom(arr) { return arr[Math.floor(Math.random() * arr.length)]; }
        ...
        const text = generateLetter(btn.dataset.type);
...
;
    ...
    updateOwnerPanel();
        ...
        document.getElementById('surpriseBtn').addEventListener('click', () => {
            const surprise = generateCompliment();
